...
export default function StackSwipeCard({ 
  stock, 
  onNext, 
  onPrevious, 
  currentIndex, 
  ...
  // Handle drag end and navigation
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        {/* Next card in stack (positioned underneath) */}
        {nextStock && (
          <div 
            className="absolute w-[100%] h-[100%] z-0 bg-gradient-to-br from-gray-800 to-black rounded-2xl shadow-xl border border-gray-700/40"
            style={{
          ...
          >
            ...
            <div className="p-4 border-b border-gray-800">
              <h2 className="text-lg font-bold text-white truncate">{nextStock.name} <span className="text-gray-500">({nextStock.ticker})</span></h2>
            ...
            {/* Blurred content */}
            <div className="w-full h-[calc(100%-76px)] bg-gray-900/50 backdrop-blur-sm"></div>
          </div>
        )}
        
        {/* Current card (top of stack) */}
        <motion.div
          className="absolute w-[100%] h-[100%] z-10 overflow-y-auto rounded-2xl bg-gradient-to-br from-gray-800 to-black shadow-2xl border border-gray-600/30"
          ref={cardRef}
          drag="x"
        ...
        >
          ...
          <div className="absolute top-2 left-0 right-0 flex justify-center z-30">
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-full px-3 py-1 text-xs border border-gray-600">
